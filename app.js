(() => {
  ...
  function enhanceAuto(imageData) {
    ...
    const loRf = loR * LEVEL_BLEND + loY * (1 - LEVEL_BLEND), hiRf = hiR * LEVEL_BLEND + hiY * (1 - LEVEL_BLEND);
    const loGf = loG * LEVEL_BLEND + loY * (1 - LEVEL_BLEND), hiGf = hiG * LEVEL_BLEND + hiY * (1 - LEVEL_BLEND);
    const loBf = loB * LEVEL_BLEND + loY * (1 - LEVEL_BLEND), hiBf = hiB * LEVEL_BLEND + hiY * (1 - LEVEL_BLEND);
  ...
  function enhanceBW(imageData) {
    ...
    const lo = histPercentile(hist, n, 0.01), hi = Math.max(lo + 10, histPercentile(hist, n, 0.97));
